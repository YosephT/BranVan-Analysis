...
class StopsControllerTest < ActionController::TestCase
  ...
  test "should create stop" do
    assert_difference('Stop.count') do
      post :create, stop: { latitude: @stop.latitude, longitude: @stop.longitude, name: @stop.name, stop_id: @stop.stop_id }
    end
  ...
  test "should update stop" do
    patch :update, id: @stop, stop: { latitude: @stop.latitude, longitude: @stop.longitude, name: @stop.name, stop_id: @stop.stop_id }
    assert_redirected_to stop_path(assigns(:stop))
  end
